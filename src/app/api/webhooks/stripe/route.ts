...
import { formatInTimeZone } from 'date-fns-tz'; // FIX 1: added import
...
export async function POST(req: Request) {
  ...
  if (event.type === "payment_intent.succeeded") {
    ...
    try {
      ...
      const durationMinutes = parseInt(m.duration) || 60;
      ...
      await calendar.events.insert({
        ...
        requestBody: {
          ...
          start: {
            // FIX 1: use formatInTimeZone to avoid UTC double-offset
            dateTime: formatInTimeZone(startTime, 'Europe/London', "yyyy-MM-dd'T'HH:mm:ss"),
            timeZone: 'Europe/London',
          },
          end: {
            dateTime: formatInTimeZone(endTime, 'Europe/London', "yyyy-MM-dd'T'HH:mm:ss"),
            timeZone: 'Europe/London',
          },
        },
      });
